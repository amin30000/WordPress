...
wsEditorData.importMenuNonce = "<?php echo esc_js(wp_create_nonce('import_custom_menu'));  ?>";
	...
	function add_extra_buttons(){
		...
		<input type="button" id='ws_edit_global_colors' value="رنگ ها" class="button ws_main_button" title="Edit default menu colors" />
		<input type="button" id='ws_edit_separator_styles' value="جداکننده ها" class="button ws_main_button" title="Edit menu separator appearance" />
		<input type="button" id='ws_edit_heading_styles' value="هدینگ ها" class="button ws_main_button" title="Edit the appearance of menu headings" />

		<div class="ws_sidebar_button_separator"></div>

		<input type="button" id='ws_export_menu' value="برون بری" class="button ws_main_button" title="Export current menu" />
		<input type="button" id='ws_import_menu' value="درون ریزی" class="button ws_main_button" />
		<?php
	}
