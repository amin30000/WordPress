...
var RexRoleEditor = /** @class */ (function () {
    function RexRoleEditor(data) {
        ...
        var postTypeCategory = new RexPostTypeContainerCategory('پست تایپ ها', this, 'postTypes');
        ...
        var taxonomyCategory = new RexTaxonomyContainerCategory('تاکسونومی ها', this, 'taxonomies');
        ...
        var customParentCategory = new RexCategory('افزونه ها', this, 'custom');
    ...
    RexRoleEditor.listView = { label: 'نمایش لیستی', id: 'list', templateName: 'rex-list-view-template' };
