...
?>">
	...
	<div class="ws_basic_container">
		...
		<form method="post" action="<?php echo esc_attr(add_query_arg('noheader', '1', $editor_data['current_tab_url'])); ?>" id='ws_main_form' name='ws_main_form'>
			...
			<input type="button" id='ws_save_menu' class="button-primary ws_main_button" value="ذخیره تغییرات" />
		</form>

			<input type="button" id='ws_reset_menu' value="بازگشت به عقب" class="button ws_main_button" />
			<input type="button" id='ws_load_menu' value="بارگذاری منوی پیشفرض" class="button ws_main_button" />
		...
		?>
			<div class="postbox ws_ame_custom_postbox <?php echo $box_class; ?>" id="ws_ame_how_to_box">
				...
				<h2 class="hndle">چگونه کار میکند؟</h2>
				<div class="inside">
					<ul class="ame-tutorial-list">
						...
						if ( $is_pro_version ):
							...
							?>
							<li><?php
								printf($how_to_link_template, 'how-to-hide-a-menu-item/', 'مخفی سازی یک منو');
								?>
								<ul class="ame-tutorial-list">
									<?php
									foreach (
										array(
											'how-to-hide-a-menu-item/#how-to-hide-a-menu-from-a-role'                   => 'ساخت یک نقش',
											'how-to-hide-a-menu-item/#how-to-hide-a-menu-from-a-user'                   => 'ساخت یک کاربر',
											'how-to-hide-a-menu-item/#how-to-hide-a-menu-from-everyone-except-yourself' => 'همه موارد مورد نیاز',
											'how-to-hide-menu-without-preventing-access/'                               => 'بدون جلوگیری از دسترسی',
										)
							...
							foreach (
								array(
									'how-to-give-access-to-menu/' => 'نمایش یک منو',
									'how-to-move-and-sort-menus/' => 'انتقال و مرتب سازی منو',
									'how-to-add-a-new-menu-item/' => 'افزودن منو',
								)
								as $how_to_url => $how_to_title
							) {
								printf($how_to_item_template, esc_attr($how_to_url), $how_to_title);
							...
							foreach (
								array(
									'how-to-hide-menus/'          => 'مخفی سازی منو',
									'how-to-hide-menus-cosmetic/' => 'مخفی سازی دسترسی',
									'how-to-add-new-menu/'        => 'افزودن منوی جدید',
								)
								as $how_to_url => $how_to_title
							) {
								printf($how_to_item_template, esc_attr($how_to_url), $how_to_title);
