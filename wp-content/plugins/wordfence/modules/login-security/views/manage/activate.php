...
<div class="wfls-block wfls-always-active wfls-flex-item-full-width">
	<div class="wfls-block-header wfls-block-header-border-bottom">
		<div class="wfls-block-header-content">
			<div class="wfls-block-title">
				<strong><?php esc_html_e('2. کد را از Authenticator App وارد کنید', 'wordfence-2fa'); ?></strong>
			</div>
		</div>
	</div>
	<div class="wfls-block-content wfls-padding-add-bottom">
		<p><?php esc_html_e('کدهای بازیابی را دانلود کنید', 'wordfence-2fa'); ?> <em class="wfls-text-small"><?php esc_html_e('اختیاری', 'wordfence-2fa'); ?></em></p>
		<p><?php echo esc_html(sprintf(__('اگر دسترسی به دستگاه احراز هویت خود را از دست دادید، از یکی از این %d کدها برای ورود به سیستم استفاده کنید. کدها %d نویسه طولانی به اضافه فاصله اختیاری هستند. هر یک فقط یک بار قابل استفاده است.', 'wordfence-2fa'), count($recovery), \WordfenceLS\Model_Crypto::strlen($recovery[0]) * 2)); ?></p>
		...
		<p><?php esc_html_e('کد برنامه احراز هویت خود را در زیر وارد کنید تا احراز هویت دو مرحله‌ای را برای این حساب تأیید و فعال کنید..', 'wordfence-2fa'); ?></p>
	...
	<div class="wfls-block-footer">
		<div class="wfls-block-footer-content">
			<div class="wfls-block-title">
				<a href="<?php echo \WordfenceLS\Controller_Support::esc_supportURL(\WordfenceLS\Controller_Support::ITEM_MODULE_LOGIN_SECURITY_2FA); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('برای راهنمایی در مورد راه اندازی یک برنامه، از مقاله راهنمای ما دیدن کنید.', 'wordfence-2fa'); ?></a>
			</div>
			<div class="wfls-block-footer-action"><a href="#" id="wfls-activate" class="wfls-btn wfls-btn-default wfls-disabled"><?php esc_html_e('فعال', 'wordfence-2fa'); ?></a></div>
		</div>
	</div>
</div>
...
<script type="text/x-jquery-template" id="wfls-tmpl-recovery-skipped-prompt">
	...
	echo \WordfenceLS\Model_View::create('common/modal-prompt', array(
		'title' => __('کدهای بازیابی را دانلود کنید', 'wordfence-2fa'),
